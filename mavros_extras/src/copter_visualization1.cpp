...
int main(int argc, char *argv[])
{
	...
	priv_nh.param<std::string>("child_frame_id", child_frame_id, "fcu1");
	...
	track_marker_pub = nh.advertise<visualization_msgs::Marker>("track_markers1", 10);
	vehicle_marker_pub = nh.advertise<visualization_msgs::MarkerArray>("vehicle_marker1", 10);
	wp_marker_pub = nh.advertise<visualization_msgs::Marker>("wp_markers1", 10);

	auto pos_sub = nh.subscribe("/mavros1/local_position/pose", 10, local_position_sub_cb);
	auto wp_sub = nh.subscribe("/mavros1/setpoint_raw/target_local_rviz", 10, setpoint_local_pos_sub_cb);
